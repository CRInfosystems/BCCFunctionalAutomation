...
Scenario: A mother and father would like to register the birth of their child.
...
And no mother and father marriage status options have been selected
When I click the 'change' link
Then I am taken to the 'whose name do you want to register' page
And no error messages are displayed
And the 'mother and father' option is selected
When I click the 'next' button
Then I am taken to the 'mother and father marriage status' page
And no mother and father marriage status options have been selected
When I click the 'next' button
