Title: ONB  Have quantity- Test that user can order 1,2,3 or 4 of each item, except black wheelie bin - WDP-188
...
Scenario:4# Have quantity- Test that user can order 1,2,3 or 4 of each item, except black wheelie bin even though user is not logged in
