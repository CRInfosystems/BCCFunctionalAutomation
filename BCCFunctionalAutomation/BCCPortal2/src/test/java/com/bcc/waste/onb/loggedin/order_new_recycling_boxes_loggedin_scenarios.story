Title: Recycling box logged In- Test user can order  recycling boxes and also 
...
Scenario:7 # Verify user can order recycling boxes when logged in
...
Examples:
waste/orderrecyclingboxesloggedin.csv