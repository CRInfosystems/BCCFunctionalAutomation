Title: Complaints -(logout) Verify user can make the complaint statutory for myself via email

Narrative: 
As a customer i should able to make the complaint statutory for myself via email even if i had not logged in to the application
	

GivenStories:

Scenario:1# (logout) Verify user can make the complaint statutory for myself via email
...
Examples:
complaints/myself_viaemail_logout_complaints_statutory.csv