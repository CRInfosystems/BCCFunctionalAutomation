Title: Complaints-Statutory -(logout) Verify user can make the statutory complaint for my self by giving my address details 
Narrative: 
As a customer i should able to make the statutory complaint for my self by giving my address details 
GivenStories:

Scenario:2# (logout) Verify user can make the statutory complaint for my self by giving my address details 
...
Examples:
complaints/myself_viaaddress_logout_complaints_statutory.csv