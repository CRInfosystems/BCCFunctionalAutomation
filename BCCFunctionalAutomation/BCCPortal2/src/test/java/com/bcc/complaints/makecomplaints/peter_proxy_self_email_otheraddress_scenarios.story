Title: Complaints -(logout) Verify user can make the complaint for some one else by giving their address and self email
Narrative: 
As a customer i should able to make the complaint for some one else by giving their address and self email
GivenStories:

Scenario:7# (logout) Verify user can make the complaint for some one else by giving their address and self email
...
Examples:
complaints/complaints_proxy_selfaddressnonuk_otheremail.csv