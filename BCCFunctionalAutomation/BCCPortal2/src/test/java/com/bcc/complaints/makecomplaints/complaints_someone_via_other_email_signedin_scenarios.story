Title: Complaints - (signed in) Verify user can make complaint for someone else via their email

Narrative: 
As a customer i should able to make the complaint for someone else without my details and other persons email if i am logged in to the application
	

GivenStories:

Scenario:1# (signed in) Verify user can make the complaint for someone else via their email
...
Examples:
complaints/someone_email_signedin_complaints.csv