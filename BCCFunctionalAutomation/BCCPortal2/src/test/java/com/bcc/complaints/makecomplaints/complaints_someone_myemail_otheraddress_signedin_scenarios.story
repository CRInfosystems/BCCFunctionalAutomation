Title: Complaints - (signed in) Verify user can make complaint for someone else via their UK address and self email

Narrative: 
As a customer i should able to make the complaint for someone else with my email (without entering explicitly) and other persons UK address if i am logged in to the application
	

GivenStories:

Scenario:1# (signed in) Verify user can make the complaint for someone else via their  address and self email
