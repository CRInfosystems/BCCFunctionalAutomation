Title: Complaints-Statutory -(logout) Verify user can make the statutory complaint as an anonymously 

Narrative: 
As a customer i should able to make the statutory complaint anonymously even if i had not logged in to the application
	

GivenStories:

Scenario:1# (logout) Verify user can make the statutory complaint as an anonymously 
...
Examples:
complaints/anonymously_complaints_statutory.csv