 ...
 * navigate to the view profile page and verifies user can navigate to the change password page
 * History      : script has been refactored as per the framework - nagajyostna - 03/03/2014
 */


public class VerifyChangePassword extends CustomerStorySteps {

	public VerifyChangePassword() {
	}
	
	/*
	 * See parent class: AccountLogin for login steps
	 */
