Title: My Account - View my profile - Verify Change Password Page - CPDP-811

Narrative: 
In order to view my profile
As a customer with an account, 
I want to view my profile 
	so that I want to navigate to change password page

GivenStories:

Scenario:2# Logged in user views profile verify navigation to change password page
