Title: Verify the user can able to select only 3 months when user purchasing multiple permits

Narrative:
In order to purchase only short term permits
AS a customer
I want system to allow purchasing only 3 month permits


GivenStories:

Scenario: 1#  Verify the user can able to select only 3 months when user purchasing multiple permits
...
Examples:
parking/parking_only_threemonths.csv