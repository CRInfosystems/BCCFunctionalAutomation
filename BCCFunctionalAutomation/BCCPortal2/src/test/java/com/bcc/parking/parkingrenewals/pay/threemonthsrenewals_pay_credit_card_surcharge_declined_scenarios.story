Title: Verify the customer get charged 1.8% extra surcharge on credit card payment if customer's card declined in first attempt 

Narrative:
In order to pay with credit card
AS a customer
I want to system to allow 


GivenStories:

Scenario: 1#  Verify the customer get charged 1.8% extra surcharge on credit card payment if customer's card declined in first attempt
...
Examples:
parkingrenewals/threemonthsrenewals_paycreditcardsurchargedeclined.csv
