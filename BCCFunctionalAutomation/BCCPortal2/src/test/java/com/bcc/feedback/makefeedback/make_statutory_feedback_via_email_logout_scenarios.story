Title: Feedback -(logout) Verify user can make statutory feedback via email

Narrative: 
As a customer i should able to make the statutory feedback via email even if i have not logged in to the application
	

GivenStories:

Scenario:1# (logout) Verify user can make the statutory feedback via email
